const CACHE='studynova-chinese-v2';
const ASSETS=['./','./index.html','./chinesemaster_writing_vault.html','./assets/styles.css','./assets/app.js','./assets/i18n.js','./assets/icon.svg','./manifest.webmanifest'];
