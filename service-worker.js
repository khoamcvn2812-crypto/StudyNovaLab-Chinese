const CACHE='studynova-chinese-v1';
const ASSETS=['./','./index.html','./chinesemaster_writing_vault.html','./assets/styles.css','./assets/app.js','./assets/icon.svg','./manifest.webmanifest'];
